    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo form_open('admin/timetable/insert_timetable', ['role' => 'form']); ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <?php echo form_dropdown('day', $days, '', 'class="form-control"'); ?>
            </div>
            <div class="bootstrap-timepicker">
              <div class="form-group">
                <label>Start Time</label>
                <div class="input-group">
                  <?php echo form_input(['id' => 'start_time', 'name' => 'start_time', 'class' => 'form-control timepicker', 'value' => set_value('start_time')]); ?>
            ...
            <div class="bootstrap-timepicker">
              <div class="form-group">
                ...
                <div class="input-group">
                  <?php echo form_input(['id' => 'end_time', 'name' => 'end_time', 'class' => 'form-control timepicker', 'value' => set_value('end_time')]); ?>
                  <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                </div>
              </div>
            </div>
