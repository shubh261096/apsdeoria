    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          ...
          <?php echo form_open("admin/teacher/update_teacher/$teacher->id", ['role' => 'form']); ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group ">
              ...
              <?php echo form_input(['id' => 'gender', 'name' => 'gender', 'class' => 'form-control', 'placeholder' => 'Enter Gender', 'type' => 'text', 'value' => set_value('gender',  $teacher->gender)]); ?>
            ...
            <div class="form-group ">
              ...
              <?php echo form_input(['id' => 'dob', 'name' => 'dob', 'class' => 'form-control', 'placeholder' => 'Enter DOB (YYYY-MM-DD)', 'type' => 'text', 'value' => set_value('dob',  $teacher->dob)]); ?>
