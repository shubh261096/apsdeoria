    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo form_open_multipart('admin/homework/insert', ['role' => 'form']); ?>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group date">
                <?php echo form_input(['id' => 'date', 'name' => 'date', 'class' => 'form-control pull-left', 'placeholder' => 'Enter Date (YYYY-MM-DD) ', 'type' => 'text', 'value' => set_value('date')]); ?>
            ...
            <div class="form-group ">
              ...
              <?php echo form_input(['id' => 'remarks', 'name' => 'remarks', 'class' => 'form-control', 'placeholder' => 'Enter Remarks', 'type' => 'text', 'value' => set_value('remarks')]); ?>
