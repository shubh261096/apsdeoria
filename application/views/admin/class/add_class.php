    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo form_open('admin/classes/add_class', ['role' => 'form']); ?>

          <div class="box-body">
            <div class="form-group ">
              <label for="InputName">Class ID</label>
              <?php echo form_input(['id' => 'id', 'name' => 'id', 'class' => 'form-control', 'placeholder' => 'Enter Class Id', 'type' => 'text', 'value' => set_value('id')]); ?>
              <?php echo form_error('id');   ?>
            </div>
            <div class="form-group ">
              <label for="InputName">Class Name</label>
              <?php echo form_input(['id' => 'name', 'name' => 'name', 'class' => 'form-control', 'placeholder' => 'Enter Class Name', 'type' => 'text', 'value' => set_value('name')]); ?>
