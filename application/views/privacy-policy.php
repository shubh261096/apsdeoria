    ...
    <div class="col-md-12">
      ...
      <div class="w3-container">
        <div class="w3-panel w3-card">
          ...
          <p class="privacy"> At Agrawal Public School, accessible from www.apsdeoria.com, one of our main
            priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected
            and recorded by Agrawal Public School and how we use it.<br>
            If you have additional questions or require more information about our Privacy Policy,
            do not hesitate to contact us through email at <a href="mailto:contact@apsdeoria.com" target="_top"><u>contact@apsdeoria.com</u></a>
          </p>


          <h2 class="logo">2. Log Files </h2>
          <p class="privacy"> Agrawal Public School follows a standard procedure of using log files.
            These files log visitors when they visit websites. All hosting companies do this and a part
            of hosting services' analytics. The information collected by log files include internet
          ...
          <h2 class="logo">3. Cookies and Web Beacons </h2>
          <p class="privacy"> Like any other website, Agrawal Public School uses 'cookies'. These cookies are used
            to
          ...
          <h2 class="logo">4. Privacy Policies </h2>
          <p class="privacy"> You may consult this list to find the Privacy Policy for each of the advertising
            partners
            of Agrawal Public School. Our Privacy Policy was created with the help of the GDPR Privacy
            Policy Generator and the Terms and Conditions Template.<br>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
            Beacons that are used in their respective advertisements and links that appear on Agrawal
            Public School, which are sent directly to users' browser. They automatically receive your
            ...
            Note that Agrawal Public School has no access to or control over these cookies
            that are used by third-party advertisers.
          </p>

          <h2 class="logo">5. Third Pary Privacy Policies </h2>
          <p class="privacy"> Agrawal Public School's Privacy Policy does not apply to other advertisers or
            websites.
          ...
          <h2 class="logo">6. Children's Information </h2>
          <p class="privacy"> Another part of our priority is adding protection for children while using the
            internet.
            We encourage parents and guardians to observe, participate in, and/or monitor and guide
            their online activity.<br>
            Agrawal Public School does not knowingly collect any Personal Identifiable Information from
          ...
          <h2 class="logo">7. Online Privacy Policy Only </h2>
          <p class="privacy"> This Privacy Policy applies only to our online activities and is valid for visitors to
            our
            website with regards to the information that they shared and/or collect in Agrawal Public
            School. This policy is not applicable to any information collected offline or via channels
